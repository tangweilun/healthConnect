      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          if (snapshot.data!.docs.isEmpty) {
            return Center(
              child:
                  Text('No managers found.', style: TextStyle(fontSize: 20.0)),
            );
          }
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 8.0),
                      Text('Manager ID: ${data['manager_id']}',
                          style: TextStyle(fontSize: 16.0)),
                      Text('Date of Birth: ${dob.day}/${dob.month}/${dob.year}',
                          style: TextStyle(
                              fontSize: 16.0)), // Format the date as needed
...
class _EditManagerDialogState extends State<EditManagerDialog> {
  ...
  void initState() {
    ...
    _phoneNumberController =
        TextEditingController(text: widget.managerData['phone_number']);
  }
