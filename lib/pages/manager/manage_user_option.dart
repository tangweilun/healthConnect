...
import 'package:health_connect/pages/manager/view_user.dart';
        ...
        child: Column(
          ...
          children: [
            ElevatedButton.icon(
              ...
              style: ButtonStyle(
                backgroundColor:
                    MaterialStateProperty.all<Color>(AppColors.darkNavyBlue),
            ...
            ElevatedButton.icon(
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          const EditUserPage()), // Navigate to EditUserPage
                );
              },
            ...
            ElevatedButton.icon(
              ...
              style: ButtonStyle(
                backgroundColor:
                    MaterialStateProperty.all<Color>(AppColors.blueGray),
                foregroundColor: MaterialStateProperty.all<Color>(Colors.white),
                padding: MaterialStateProperty.all<EdgeInsetsGeometry>(
                    const EdgeInsets.symmetric(vertical: 20, horizontal: 50)),
              ),
