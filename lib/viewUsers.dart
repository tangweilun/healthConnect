...
final List<FirebaseData> firebaseDataList = [
  FirebaseData(id: '1', name: 'User 1', description: 'Description 1'),
  FirebaseData(id: '2', name: 'User 2', description: 'Description 2'),
  FirebaseData(id: '3', name: 'User 3', description: 'Description 3'),
